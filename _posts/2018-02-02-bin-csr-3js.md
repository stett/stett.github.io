...
<div class="centered">Size</div>
<div class="centered">
<input type="range" min="1" max="32" step="1" value="8" oninput="interactResizeMatrix(this.value)">
</div>
<div class="centered">Density</div>
<div class="centered">
<input type="range" min="0" max="1" step="0.1" value="0.2" oninput="interactChangeDensity(this.value)">
</div>
...
$(document).ready(function() {
    ...
    interactChangeDensity = function(new_density) {
        density = new_density;
        matrix = []
        interactUpdateMatrix();
    }
    ...
    interactUpdateMatrix = function() {
        ...
        while (matrix_size > matrix.length) {
            ...
            for (var i = 0; i < matrix.length; ++i) {
                ...
                var val = dice < density ? 1 + Math.floor(Math.random() * Math.floor(9)) : 0;
                matrix[i].push(val);
                new_row.push(val);
            }
